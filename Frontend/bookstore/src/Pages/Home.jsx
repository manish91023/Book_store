...
const course_url=import.meta.env.VITE_COURSE_API
...
function Home() {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        const response = await axios.get(`${backend_url}/course/getAllCourses`, {
                ...
                <div className="relative flex-shrink-0 w-92 transition-transform duration-300 transform hover:scale-105">
                  <div className="bg-gray-900 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      ...
                      <Link to={`/buy/${course._id}`} className="  bg-orange-500 text-white py-2 px-4 rounded-full hover:bg-blue-500 duration-300">
                        Enroll Now
                      </Link>
                    </div>
                  </div>
            ...
            <div className="items-center mt-6 md:mt-0 flex flex-col">
              ...
              <ul className=" space-y-2 text-gray-400">
                ...
                <li className="hover:text-white cursor-pointer duration-300">
                  Github- <a href="https://github.com/manish91023" target="_blank">Go</a>
                </li>
                <li className="hover:text-white cursor-pointer duration-300">
                  Linkedin- <a href="https://www.linkedin.com/in/manish-kumar-319125291/" target="_blank">Go</a>
                </li>
              </ul>
            </div>
            <div className="items-center mt-6 md:mt-0 flex flex-col">
